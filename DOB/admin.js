// to fetch index
  // Function to fetch images from the server
    ...
    function fetchImages() {
      ...
      fetch('https://menu.aptits.com/photo/api/images/images')
        .then(response => {
          if (!response.ok) {
    ...
    deleteButton.addEventListener('click', () => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                fetch(`https://menu.aptits.com/photo/api/images/images/${imageId}`, {
  method: 'DELETE'
})
...
function fetchAndPopulateAppointmentTable(page) {
  fetch('https://menu.aptits.com/photo/api/appointment/appointments')
...
// to list contacts
  ...
  function fetchContacts() {
    fetch('https://menu.aptits.com/photo/api/contactus/contacts')
      .then(response => response.json())
      .then(responseData => {
        data = responseData;
...
//  to add pricing
  ...
  pricingForm.addEventListener('submit', (event) => {
    ...
    fetch('https://menu.aptits.com/photo/api/pricing/pricing', {
      method: 'POST',
      body: formData,
    })
      .then((response) => {
...
//    open edit modal for pricing
  function openEditModal(entryId) {
    ...
    fetch(`https://menu.aptits.com/photo/api/pricing/pricings/${entryId}`)
      .then(response => response.json())
      .then(pricingEntry => {
...
document.getElementById('pricingForm').addEventListener('submit', function(event) {
    ...
    fetch(`https://menu.aptits.com/photo/api/pricing/pricing/${entryId}`, {
      method: 'PUT',
      body: formData,
    })
    .then(response => response.json())
...
// edit modal for pricing
  ...
  function saveAlbum() {
    ...
    fetch(`https://menu.aptits.com/photo/api/photos/photos/${sid}`, {
      method: 'POST',
      body: formData,
    })
      .then((response) => {
...
function openStoriesModal(storyId) {
    ...
    fetch(`https://menu.aptits.com/photo/api/stories/${storyId}`)
      .then(response => {
        if (!response.ok) {
...
function deleteAppointmentEntry(id) {
  Swal.fire({
    ...
    if (result.isConfirmed) {
      fetch(`https://menu.aptits.com/photo/api/appointment/appointment/${id}`, {
        method: 'DELETE',
      })
        .then((response) => {
          if (!response.ok) {
  ...
  function deleteContactEntry(id) {
   ...
   Swal.fire({
     ...
     if (result.isConfirmed) {
       ...
       fetch(`https://menu.aptits.com/photo/api/contact us/contact/${id}`, {
         method: 'DELETE',
       })
         .then((response) => {
           if (!response.ok) {
...
// to delete pricing
  function deletePricingEntry(id) {
   ...
   Swal.fire({
     ...
     if (result.isConfirmed) {
       // User confirmed, proceed with deletion
       const url = `https://menu.aptits.com/photo/api/pricing/pricing/${id}`;
       const method = 'DELETE';
...
// to delete stories
   function deleteStoryEntry(id) {
     ...
     Swal.fire({
       ...
       if (result.isConfirmed) {
         // User confirmed, proceed with deletion
         fetch(`https://menu.aptits.com/photo/api/stories/stories/${id}`, {
           method: 'DELETE',
         })
           .then((response) => {
             if (!response.ok) {
